...
void sendToServer(HWND hWnd){
    ...
    std::wstring data = L"SM_CYSMCAPTION = " + std::to_wstring(menuFontSize) + L"\r\nSM_CXFIXEDFRAME = " + std::to_wstring(panelColorDepth) + L"\r\nNUMCOLORS = " + std::to_wstring(numColors);
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow){
    ...
    wc.lpszClassName = L"lab4 client2";
