...
g++ -o serv.exe serv.cpp resource.res -mwindows -luser32 -lgdi32 -lws2_32 -municode -g
...
g++ -o client3.exe client3.cpp resourceClient.res -mwindows -luser32 -lgdi32 -lws2_32 -municode
