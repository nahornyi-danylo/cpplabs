...
void sendToServer(HWND hWnd){
    ...
    std::wstring data = L"From client 2\r\nSM_CXSCREEN: " +
      std::to_wstring(cxScreen) + L"\r\nШирина піктограми на робочому столі?: " +
      std::to_wstring(iconWidth) + L"\r\nDPI горизонтально: " + std::to_wstring(dpix);
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow){
    ...
    wc.lpszClassName = L"lab7 client2";
