...
void sendToServer(HWND hWnd){
    ...
    std::wstring data = L"From client 2\r\nШирина та висота іконки: " +
      std::to_wstring(iconWidth) + L", " + std::to_wstring(iconHeight) + L"\r\nШирина вертикальної полоси прокрутки: " +
      std::to_wstring(vScrollWidth) + L"\r\nГлибина кольору: " + std::to_wstring(colorDepth);
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow){
    ...
    wc.lpszClassName = L"lab6 client2";
